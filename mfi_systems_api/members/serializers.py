...
class GroupMemberSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        student, created = GroupMember.objects.update_or_create(user=user,

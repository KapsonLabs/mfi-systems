...
class InstitutionStaff(models.Model):
    ...
    user_id                        = models.OneToOneField(User, on_delete=models.CASCADE, related_name='institution_user')
    ...
    staff_responsibility           = models.TextField(null=True, blank=True)
    phone_dialing_code             = models.CharField(max_length=4, null=True, blank=True)

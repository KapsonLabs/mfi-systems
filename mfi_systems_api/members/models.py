...
class GroupMember(models.Model):
    ...
    id_attachment_front         = models.ImageField(upload_to='images')#[image_front_face, image_back_face],
    id_attachment_back          = models.ImageField(upload_to='images')#[image_front_face, image_back_face],
    ...
    def __str__(self):
        return "{} Member belongs to {} group".format(self.username, self.group_id)